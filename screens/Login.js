...
const Login = ({ navigation }) => {
    ...
    const setDevtoken = async (devtoken, savedToken) => {
        const url = `http://192.168.43.210:3000/it4788/user/set_devtoken?token=${savedToken}&devtoken=${devtoken}`
    ...
    const signInUser = async () => {
        ...
        let url = `http://192.168.43.210:3000/it4788/user/login?phonenumber=${username}&password=${password}&uuid=${savedToken}`
